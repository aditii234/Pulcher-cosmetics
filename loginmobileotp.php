...
<body>
  ...
  <div class="otp-container">
    <h2>Enter OTP</h2>
    <p>The OTP is sent on mobile</p>
    <div class="phone-display">
      <a href="loginmobile.php" class="edit-link">
        +91 9857452147 <i class="fa fa-edit edit-icon"></i>
      </a>
    </div>
    ...
    <div class="error-message" id="errorMessage" style="display:none; color: red; margin-top: 10px;">
  ...
  const isValidOTP = /^\d{6}$/.test(enteredOTP); // Checks if it's exactly 6 digits

  if (isValidOTP) {
    successMsg.style.display = 'flex';
    errorMsg.style.display = 'none';
    setTimeout(() => {
      window.location.href = "loginaccount.php"; // Replace with your redirect page
    }, 1500);
  } else {
